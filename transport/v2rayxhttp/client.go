...
type Client struct {
	...
	downloadServerAddr   M.Socksaddr
	httpVersion          string
	downloadHTTPVersion  string
	hasDownloadTransport bool
...
func NewClient(ctx context.Context, logger log.ContextLogger, dialer N.Dialer, serverAddr M.Socksaddr, options option.V2RayXHTTPOptions, tlsConfig tls.Config) (adapter.V2RayClientTransport, error) {
	...
	if options.Download != nil {
		...
		httpVersion2 = decideHTTPVersion(tlsConfig2)
	...
	return &Client{
		...
		options:              &options,
		serverAddr:           dest,
		downloadServerAddr:   dest2,
		httpVersion:          httpVersion,
		downloadHTTPVersion:  httpVersion2,
		hasDownloadTransport: options.Download != nil,
...
func (c *Client) DialContext(ctx context.Context) (net.Conn, error) {
	...
	c.logger.DebugContext(ctx, "XHTTP is dialing to ", c.serverAddr, ", mode ", mode, ", HTTP version ", c.httpVersion, ", host ", requestURL.Host)
	if c.hasDownloadTransport {
		c.logger.DebugContext(ctx, "XHTTP is downloading from ", c.downloadServerAddr, ", mode stream-down, HTTP version ", c.downloadHTTPVersion, ", host ", requestURL2.Host)
	}
	if xmuxClient != nil {
...
func (c *Client) normalizedMode() string {
